...
![](https://assets.tryhackme.com/additional/imgur/JkWeFLq.png)
...
In the above examples the payload used was

```
shell_reverse_tcp
```

. This indicates that it was a

*stageless*

payload. How? Stageless payloads are denoted with underscores (
...
![](https://assets.tryhackme.com/additional/imgur/iFO6ydX.png)
